...
<p align="center">
  <em>Training models, breaking models, then training them better.</em>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Focus-AI_/_ML_Training-1f6feb?style=flat-square&logo=pytorch&logoColor=white" />
...
<p align="center">
  <a href="https://github.com/SangeethaRachaALT">
    <img alt="GitHub streak"
         src="https://github-readme-streak-stats.herokuapp.com/?user=SangeethaRachaALT&theme=tokyonight&hide_border=true&card_width=420"
         height="180" />
  </a>
  <a href="https://github.com/SangeethaRachaALT">
...
<p align="center">
  <a href="https://github.com/SangeethaRachaALT">
    <img alt="Contribution activity graph"
         src="https://github-readme-activity-graph.vercel.app/graph?username=SangeethaRachaALT&theme=tokyo-night&hide_border=true&area=true&radius=8" />
  </a>
</p>
...
Right now my time goes into three places:
...
- **Reinforcement learning** — DQN and PPO on Gymnasium environments. Implementing them from scratch (CleanRL-style, single file each) because the implementation details matter more than the algorithm names.

The shared infrastructure (training loop helpers, eval pipelines, checkpoint utilities) ties them together — if a metric helper doesn't generalize across LLM, vision, and RL, it doesn't earn its place in the lab.

---

## 📦 Projects

### 🧪 ai-research-lab *(private)*
...
### 📒 [ml-cheatsheets](https://github.com/SangeethaRachaALT/ml-cheatsheets)

Quick-reference notes I keep returning to: LR schedules, mixed precision (bf16 vs fp16), LoRA tuning, RL implementation tips, eval honesty, GPU debugging. Each file is one topic, kept short on purpose.

### 🔧 [pytorch-snippets](https://github.com/SangeethaRachaALT/pytorch-snippets)

Small reusable PyTorch utilities I keep copy-pasting: seeding, device picking, parameter counting, warmup-cosine LR schedulers, sane DataLoader defaults, patience-based early stopping, layer freezing, plus a CUDA ReLU kernel and a minimal C++ tensor-extension example.

### 🗂 [dataset-tools](https://github.com/SangeethaRachaALT/dataset-tools)
...
**Frameworks I lean on**: `transformers`, `peft`, `accelerate`, `bitsandbytes`, `gymnasium`, `stable-baselines3`, `cleanrl`, `timm`, `albumentations`.
...
<p>
  <a href="mailto:sangeetha.racha08@gmail.com">
